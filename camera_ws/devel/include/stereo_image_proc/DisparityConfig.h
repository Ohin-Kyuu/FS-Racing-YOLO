...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DisparityConfig::AbstractParamDescriptionConstPtr(new DisparityConfig::ParamDescription<int>("stereo_algorithm", "int", 0, "stereo algorithm", "{'enum': [{'name': 'StereoBM', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'description': 'Block Matching', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'StereoSGBM', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'description': 'SemiGlobal Block Matching', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'stereo algorithm'}", &DisparityConfig::stereo_algorithm)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/home/ws/camera_ws/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
      const int Disparity_StereoBM = 0;
//#line 12 "/home/ws/camera_ws/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
