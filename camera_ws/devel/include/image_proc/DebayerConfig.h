...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 15, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 15, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));
...
//#line 9 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_Bilinear = 0;
//#line 11 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAware = 1;
//#line 13 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
      const int Debayer_EdgeAwareWeighted = 2;
//#line 15 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg"
