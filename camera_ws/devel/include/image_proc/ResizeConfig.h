...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &ResizeConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Nearest neighbor', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Linear', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 13, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Cubic', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'description': 'Lanczos4', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &ResizeConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.use_scale = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.use_scale = 1;
...
//#line 11 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_NN = 0;
//#line 12 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Linear = 1;
//#line 13 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Cubic = 2;
//#line 14 "/home/ws/camera_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
